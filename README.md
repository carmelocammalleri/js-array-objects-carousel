...
1. sistemare il carosello
2. modificare la lista degli elementi ed inserire un array ad oggetti
3. posizionare le info dell'array ad oggetti sopra l'immagine
4. stampare tutto sul HTML